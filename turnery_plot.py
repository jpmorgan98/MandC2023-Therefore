...
for i in range(N_angles.size):
    ...
    tax = ternary.TernaryAxesSubplot(ax=ax[row, col], scale=scale)
...
#cbar = figure.colorbar(hm, ax=ax.ravel().tolist())
